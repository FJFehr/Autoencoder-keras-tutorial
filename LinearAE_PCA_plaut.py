# Principal component analysis using a linear autoencoder, as described in the paper:
# From Principal Subspaces to Principal Components with Linear Autoencoders by
# Elad Plaut https://arxiv.org/pdf/1804.10253.pdf
#
# This code runs a AE and PCA and compares them for MNIST
# 8 June 2020
# Fabio Fehr
